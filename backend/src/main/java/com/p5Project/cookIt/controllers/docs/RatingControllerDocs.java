...
public interface RatingControllerDocs {
    ...
    RatingDTO findRatingById(@Parameter(description = "ID da avaliação", required = true) @PathVariable UUID id);
    ...
    ResponseEntity<PagedModel<EntityModel<RatingDTO>>> findAllRatings(Integer page, Integer size, String direction);
    ...
    RatingDTO createRating(@RequestBody(description = "Objeto contendo os dados da avaliação", required = true, content = @Content(schema = @Schema(implementation = RatingDTO.class))) @org.springframework.web.bind.annotation.RequestBody RatingDTO rating);
    ...
    RatingDTO updateRating(@RequestBody(description = "Objeto contendo os dados atualizados da avaliação", required = true, content = @Content(schema = @Schema(implementation = RatingDTO.class))) @org.springframework.web.bind.annotation.RequestBody RatingDTO rating);
    ...
    RatingDTO updateRatingField(@Parameter(description = "ID da avaliação", required = true) @PathVariable UUID id,
    ...
    ResponseEntity<?> deleteRating(@Parameter(description = "ID da avaliação", required = true) @PathVariable UUID id);
}
