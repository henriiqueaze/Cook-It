...
function mapearMensagemErroEsqueciSenha(message: string) {
  ...
  if (
    ...
    normalizado.includes("nao encontramos")
  ) {
    return "Nao encontramos uma conta com este e-mail. Verifique o endereco digitado.";
  }

  return "Nao foi possivel enviar o codigo agora. Tente novamente em instantes.";
}
